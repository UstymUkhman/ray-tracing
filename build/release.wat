(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34520))
 (memory $0 1)
 ...
 (data $7.1 (i32.const 1448) "\02\00\00\00 \00\00\00~\00l\00i\00b\00/\00r\00t\00/\00i\00t\00c\00m\00s\00.\00t\00s")
 (data $10 (i32.const 1564) ",")
 (data $10.1 (i32.const 1576) "\02\00\00\00\14\00\00\00~\00l\00i\00b\00/\00r\00t\00.\00t\00s")
 (data $12 (i32.const 1644) "<")
 (data $12.1 (i32.const 1656) "\02\00\00\00\1e\00\00\00~\00l\00i\00b\00/\00r\00t\00/\00t\00l\00s\00f\00.\00t\00s")
 (data $13 (i32.const 1712) "\t\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\01\19\00\00A\00\00\00\00\00\00\00$\1a")
 (table $0 2 2 funcref)
 ...
 (func $start:assembly/utils/Color~anonymous|0 (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 f64)
  (local $5 i32)
  (local $6 i32)
  ...
  block $folding-inner0
   ...
   block $3of3
    block $outOfRange
     ...
     br_table $3of3 $3of3 $3of3 $3of3 $outOfRange
    end
    unreachable
   end
   global.get $~lib/memory/__stack_pointer
